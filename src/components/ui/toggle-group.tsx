    ...
    <ToggleGroupPrimitive.Item
      ...
      className={cn(
        ...
        context.orientation === 'vertical'
          ...
          : 'data-[spacing=0]:first:rounded-l-md data-[spacing=0]:last:rounded-r-md data-[spacing=0]:data-[variant=outline]:border-l-0 data-[spacing=0]:data-[variant=outline]:first:border-l',
        className,
      )}
      {...props}
    >
